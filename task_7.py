...
time = int(input("Введите время в часах от 0 до 23 часов: "))

if (time >= 8 and time <= 22) and not (time <= 15 and time >= 14) and not (time >= 10 and time <= 12) and not (time >= 18 and time <= 20):
